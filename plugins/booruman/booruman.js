(function () {
  ...
  let BOORUMAN_API_URL = "https://cc1234-deepdanbooru.hf.space/api/predict";
  let THRESHOLD = 0.6; // remove matches with a distance higher than this

  /**
   * Retrieves the tags associated with a given image ID.
   *
   * @param {string} image_id - The ID of the image to retrieve tags for.
  ...
  function create_fragment$2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div0, file$2, 24, 4, 440);
        attr_dev(div1, "class", "progress");
        set_style(div1, "height", "5px");
        add_location(div1, file$2, 23, 2, 393);
        attr_dev(
          path,
          "d",
        ...
        attr_dev(svg, "class", "tag-item-reject svelte-ai57u1");
        add_location(svg, file$2, 35, 4, 737);
        attr_dev(span, "class", "tag-item badge badge-secondary svelte-ai57u1");
        add_location(span, file$2, 33, 2, 676);
        attr_dev(div2, "class", "tag svelte-ai57u1");
        add_location(div2, file$2, 22, 0, 373);
      },
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$$.on_mount.push(function () {
      ...
      if (
        prob === undefined &&
        !("prob" in $$props || $$self.$$.bound[$$self.$$.props["prob"]])
      ) {
        console.warn("<Tag> was created without expected prop 'prob'");
      }
    });

    const writable_props = ["id", "name", "prob"];
    ...
    $$self.$$set = ($$props) => {
      ...
      if ("prob" in $$props) $$invalidate(2, (prob = $$props.prob));
    };
    ...
    return [id, name, prob, dispatch, click_handler];
  }
  ...
  function create_if_block(ctx) {
    ...
    let mounted;
    let dispose;
    let each_value = /*filteredMatches*/ ctx[4];
    ...
    let if_block = /*saving*/ ctx[2] && create_if_block_1(ctx);
    ...
    const block = {
      c: function create() {
        ...
        add_location(div8, file$1, 77, 2, 1884);
      },
      m: function mount(target, anchor) {
      ...
      p: function update(ctx, dirty) {
        if (dirty & /*filteredMatches, remove*/ 80) {
          each_value = /*filteredMatches*/ ctx[4];
          validate_each_argument(each_value);
          group_outros();
        ...
        if (
          (!current || dirty & /*threshold*/ 1) &&
          t9_value !== (t9_value = /*threshold*/ ctx[0] * 100 + "")
        )
  ...
  // (95:12) {#each filteredMatches as tag (tag.id)}
  function create_each_block(key_1, ctx) {
    ...
    let current;
    const tag_spread_levels = [/*tag*/ ctx[13]];
    let tag_props = {};
    ...
    const block = {
      ...
      c: function create() {
        ...
        t = space();
        add_location(div, file$1, 95, 14, 2451);
        this.first = div;
      },
      m: function mount(target, anchor) {
      ...
      p: function update(new_ctx, dirty) {
        ...
        const tag_changes =
          dirty & /*filteredMatches*/ 16
            ? get_spread_update(tag_spread_levels, [
                get_spread_object(/*tag*/ ctx[13]),
              ])
            : {};
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(95:12) {#each filteredMatches as tag (tag.id)}",
      ctx,
    });
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div, file$1, 120, 16, 3167);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
      },
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    // Convert the incoming matching data to an array with a random id, name, and probability
    matches = Object.entries(matches).map(([name, prob]) => ({
    ...
    function remove(event) {
      ...
      $$invalidate(9, (matches = matches.filter((x) => x.id !== id)));
    }

    async function save() {
      $$invalidate(2, (saving = true));
      const [, image_id] = getScenarioAndID();
      let existingTags = await getTagsForImage(image_id);
      ...
      for (const tag of filteredMatches) {
        ...
        if (tags[tagLower] === undefined) {
          existingTags.push(await createTag(tagLower));
        } else if (!existingTags.includes(tags[tagLower])) {
          existingTags.push(tags[tagLower]);
        }
      }

      await updateImage(image_id, existingTags);
    ...
    function changeThreshold() {
      localStorage.setItem("stash-readbooru-threshold", threshold);
    }

    const writable_props = ["matches", "threshold"];
    ...
    Object_1.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<TagMatches> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$$set = ($$props) => {
      if ("matches" in $$props) $$invalidate(9, (matches = $$props.matches));
      if ("threshold" in $$props)
        $$invalidate(0, (threshold = $$props.threshold));
    };
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("filteredMatches" in $$props)
        $$invalidate(4, (filteredMatches = $$props.filteredMatches));
    };
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(g2, "transform", "translate(64.000000, 64.000000)");
        add_location(g2, file, 65, 434, 2162);
        attr_dev(g3, "id", "Page-1");
        attr_dev(g3, "stroke", "none");
        attr_dev(g3, "stroke-width", "1");
        attr_dev(g3, "fill", "none");
        attr_dev(g3, "fill-rule", "evenodd");
        add_location(g3, file, 65, 355, 2083);
        attr_dev(g4, "id", "SVGRepo_iconCarrier");
        add_location(g4, file, 65, 308, 2036);
        ...
        add_location(svg, file, 65, 2, 1730);
        attr_dev(button, "id", "booruman");
        attr_dev(button, "class", "svelte-1m5gxnd");
        toggle_class(button, "scanner", /*scanner*/ ctx[0]);
        add_location(button, file, 64, 0, 1664);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    function recognize() {
      ...
      html2canvas(document.querySelector(selector)).then((canvas) => {
        ...
        let data = { data: [image, THRESHOLD] };

        fetch(BOORUMAN_API_URL, {
          method: "POST",
          headers: {
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console_1.warn(`<TagButton> was created with unknown prop '${key}'`);
    });
    ...
    return [scanner, recognize, calls];
  }
  ...
  function createTagButton(target) {
    if (document.querySelector("#booruman")) return;
