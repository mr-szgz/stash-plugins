---
url: https://docs.stashapp.cc/in-app-manual/plugins/externalplugins/
title: External plugins - Stash-Docs
description: Stash documentation, guides, plugins and support.
access_date: 2026-03-31T18:09:08.000Z
current_date: 2026-03-31T18:09:08.902Z
---
...
For external plugin tasks, the `interface` field must be set to one of the following values: \* `rpc`\* `raw`
